...
var buildTree = function(inorder, postorder) {
    ...
    // root.left = buildTree(postorder.slice(0, indexinorder), inorder.slice(0, indexinorder));
    // root.right = buildTree(postorder.slice(indexinorder, postorder.length - 1), inorder.slice(indexinorder + 1, inorder.length));
    // return root;
